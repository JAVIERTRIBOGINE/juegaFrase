...
$(document).ready(function () {
    ...
    var count = 0;
    var oks = 0;
    palabras[0]=JSON.parse(jsonAdj); 
    palabras[1]=JSON.parse(jsonVerb); 
    palabras[2]=JSON.parse(jsonNomb); 
    var totNouns = (palabras[0].length) + (palabras[1].length) + (palabras[2].length);
